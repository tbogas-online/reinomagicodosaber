...
(function (global) {
  ...
  const RETRY_HINT_BY_CODE = Object.freeze({
    ...
    CONTENT_BLOCKED: 'Conteúdo inadequado para o jogo familiar — escolhe outro tema ou reformula sem violência, drogas ou linguagem explícita.',
  ...
  const RETRY_HINT_RULES = [
    ...
    { re: /linguagem inadequada|palavr|insulto|cal[aã]o|ofensiv|conte[uú]do inadequado/i, hint: RETRY_HINT_BY_CODE.PT_OFFENSIVE_LANGUAGE },
